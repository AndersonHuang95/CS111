...
static struct option long_options[] = {
	...
	**********************************************/
	// File-opening flags & verbose option 
...
unistd.h defines close & pipe
fcntl.h defines open
string.h defines strcmp
TODO: 
Fix the default option in the swtich statement to print a better error diagnostic
dup2 and stdout file descriptor (check lecture notes) 
Closing a file twice 

CLOSING ALL FILE DESCRIPTORS IN CHILD PROCESS VS. JUST CLOSING PIPES??
*/
